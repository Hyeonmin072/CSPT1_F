        ...
        <div className="flex w-full max-w-4xl border-b-2">
            ...
            <div className="p-8">
                ...
                <div className="flex items-center mb-4">
                    ...
                    <span className="w-[400px] border rounded p-2 bg-gray-100">{CurriculumVitae.name}</span>
                </div>

                {/* 이메일 (수정 불가능) */}
                <div className="flex items-center mb-4">
                    <label className="w-32 text-gray-700 font-bold">이메일</label>
                    <span className="w-[400px] border rounded p-2 bg-gray-100">{CurriculumVitae.email}</span>
                </div>

                {/* 전화번호 (수정 불가능) */}
                <div className="flex items-center mb-4">
                    <label className="w-32 text-gray-700 font-bold">전화번호</label>
                    <span className="w-[400px] border rounded p-2 bg-gray-100">{CurriculumVitae.tel}</span>
                </div>

                {/* 성별 (수정 불가능) */}
                <div className="flex items-center mb-4">
                    <label className="w-32 text-gray-700 font-bold">성별</label>
                    <span className="w-[400px] border rounded p-2 bg-gray-100">{CurriculumVitae.gender}</span>
                </div>

                {/* 나이 (수정 불가능) */}
                <div className="flex items-center mb-4">
                    <label className="w-32 text-gray-700 font-bold">나이</label>
                    <span className="w-[400px] border rounded p-2 bg-gray-100">{CurriculumVitae.age}</span>
                </div>
            </div>
        </div>
    );
