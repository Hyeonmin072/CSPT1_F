...
export const dummySchedules = [
    { id: 1, time: "13:00", client: "김수진 고객님", menu: "[EVENT]르블라썸 복구 매직", status: "완료", day: "월", date: "2025-03-24", cash: "55,000원" },
    { id: 1, time: "15:00", client: "황의정 고객님", menu: "앞머리 컷", status: "완료", day: "화", date: "2025-03-18", cash: "17,000원" },
    { id: 1, time: "20:00", client: "최희정 고객님", menu: "아윤채 모발 클리닉", status: "미완료", day: "수", date: "2025-03-26", cash: "13,000원" },
    { id: 1, time: "22:00", client: "김나윤 고객님", menu: "프리미엄염색", status: "미완료", day: "목", date: "2025-03-20", cash: "122,000원" },
    { id: 2, time: "16:00", client: "한세진 고객님", menu: "샴푸 + 드라이", status: "완료", day: "금", date: "2025-03-21", cash: "22,000원" },
    { id: 2, time: "08:00", client: "Cameron 고객님", menu: "샴푸 + 드라이", status: "완료", day: "월", date: "2025-03-26", cash: "17,000원" },
    { id: 1, time: "11:00", client: "한세진 고객님", menu: "[시그니처]CS컬 드라이 펌", status: "완료", day: "화", date: "2025-03-23", cash: "17,000원" },
    { id: 2, time: "11:00", client: "한세진 고객님", menu: "[시그니처]CS컬 드라이 펌", status: "완료", day: "화", date: "2025-03-26", cash: "21,000원" },
];
