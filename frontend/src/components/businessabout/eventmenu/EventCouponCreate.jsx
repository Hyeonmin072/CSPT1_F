...
export default function EventCouponCreate() {
  ...
  const handleCouponSubmit = async () => {
    ...
    try {
      const response = await axiosInstance.post("/shop/coupons", newCoupon);
  ...
  const handleEventSubmit = async () => {
    ...
    try {
      const response = await axiosInstance.post("/shop/events", newEvent);
          ...
          <div>
            ...
            <FormSection title="수령 가능 기간">
              <Input
                ...
                onChange={(e) =>
                  setNewCoupon({ ...newCoupon, getDate: e.target.value })
                }
              />
            </FormSection>
            ...
            <FormSection title="사용 가능 기간">
              <Input
                ...
                onChange={(e) =>
                  setNewCoupon({ ...newCoupon, useDate: e.target.value })
                }
              />
            </FormSection>
            ...
            {newCoupon.type && (
              <FormSection
                title={
                  newCoupon.type === "PERCENT" ? "할인율 (%)" : "할인 금액 (원)"
                }
              >
                <Input
                  type="number"
