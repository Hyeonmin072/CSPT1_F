...
export default function CouponModal({ isOpen, onClose }) {
    ...
    return (
        <div className="fixed inset-0 flex items-center justify-center bg-black bg-opacity-50">
            <div className="bg-white p-8 rounded-lg shadow-lg" style={{ width: '600px', height: '85vh' }}> {/* 높이를 85vh로 조정 */}
                ...
                <div className="overflow-y-auto no-scrollbar"
                     style={{ maxHeight: '71vh', scrollbarWidth: 'none', msOverflowStyle: 'none' }}> {/* maxHeight 값을 조정 */}
                    <style jsx>{`
                        /* 스크롤바를 숨기기 위한 스타일 */
                    ...
                    {coupons.map(coupon => (
                        <div key={coupon.id}
                            ...
                            <div className="border-dashed border-r-2 border-gray-400 absolute left-20 top-0 bottom-0"
