...
const BusinessSideBar = ({ isOpen, onClose }) => {
  ...
  const menuItems = [
    ...
    { id: 2, title: "예약 관리", path: "/reservations" },
    { id: 3, title: "소속 디자이너 관리", path: "/designermanage" },
    { id: 4, title: "메뉴 관리",  path: "/menu-setting" },
    ...
    { id: 10, title: "내 프로필",  path: "/shop/profile" },
    { id: 11, title: "블랙리스트 관리", path: "/blacklist" },
    { id: 12, title: "공지사항 관리", path: "/notices" },
  ];
