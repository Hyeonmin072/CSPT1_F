                ...
                <table className="w-full border-separate border-spacing-2">
                    ...
                    {reservations.length === 0 ? (
                        ...
                        reservations.map((res, index) => (
                            <tr key={index} className="border-b hover:bg-green-50 transition duration-300 ease-in-out">
                                ...
                                <td className="py-3 px-4 font-semibold text-green-600">{formatPrice(res.menuPrice)}</td>
                            </tr>
                        ))
                    )}
                    </tbody>
