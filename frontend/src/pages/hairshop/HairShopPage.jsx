...
export default function HairShopPage() {
  ...
  const [stats, setStats] = useState({
    registeredShopCnt: 0,
    registeredDesignerCnt: 0,
    registeredReviewCnt: 0,
  });
    ...
    <div className="min-h-screen bg-gray-50">
            ...
            <div className="flex flex-col md:flex-row gap-4">
              ...
              <div className="flex-1 relative">
                ...
                <input
                  ...
                  className="w-full text-black pl-10 pr-4 py-3 rounded-lg border border-gray-300 focus:outline-none focus:ring-2 focus:ring-green-500"
                  value={searchQuery}
      ...
      <div className="max-w-7xl mx-auto px-4 py-8">
        <div className="flex justify-between items-center mb-6">
          <h2 className="text-2xl font-bold">헤어샵 목록</h2>
